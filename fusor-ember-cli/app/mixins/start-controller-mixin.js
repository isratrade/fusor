...
export default Ember.Mixin.create({
  ...
  // images
  imgRhev: function() {
    if (this.get('isUpstream')) { return "/r/assets/ovirt-640-210.png"; } else { return "/r/assets/rhci-rhev-640-210.png"; }
  }.property('isUpstream'),

  imgOpenStack: function() {
    if (this.get('isUpstream')) { return "/r/assets/rdo-640-210.png"; } else { return "/r/assets/rhci-openstack-640-210.png"; }
  }.property('isUpstream'),

  imgCloudForms: function() {
    if (this.get('isUpstream')) { return "/r/assets/manageiq-640-210.png"; } else { return "/r/assets/rhci-cloudforms-640-210.png"; }
  }.property('isUpstream'),
