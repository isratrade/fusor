...
export default function() {
  ...
  this.get('/fusor/api/v3/openstack_deployments');
  this.post('/fusor/api/v3/openstack_deployments');
  this.get('/fusor/api/v3/openstack_deployments/:id');
  ...
  this.get('/api/v3/lifecycle_environments');
  this.get('/api/v3/lifecycle_environments/:id');
  this.post('/api/v3/lifecycle_environments', function(db, request) {
