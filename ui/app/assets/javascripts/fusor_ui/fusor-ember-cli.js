...
define('fusor-ember-cli/templates/components/rhci-start', ['exports', 'ember'], function (exports, Ember) {
  ...
  function program5(depth0,data) {
    ...
    data.buffer.push(escapeExpression((helper = helpers['fa-icon'] || (depth0 && depth0['fa-icon']),options={hash:{
      'spin': (true),
      'size': (5)
    },hashTypes:{'spin': "BOOLEAN",'size': "INTEGER"},hashContexts:{'spin': depth0,'size': depth0},contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "camera", options) : helperMissing.call(depth0, "fa-icon", "camera", options))));
